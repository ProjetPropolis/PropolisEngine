...
{ 
    ...
    {
        public const float DefaultGameTickTime = 4.0f; // Tick update de la corruption par défaut (difficulté à 1)     
        ...
        public const float MaxStableDifficultyThreshold = 0.45f; // Pourcentage plancher increase difficulty
        public const float DifficultyUpdateDeltaTime = 0.3f; // Temp entre deux analyse de la difficultée
        public const float BatteryUpdateDeltaTime =  15.0f;// Temp entre deux analyse pour le réservoir
