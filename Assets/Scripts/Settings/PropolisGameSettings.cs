...
{ 
    ...
    {
        public const float DefaultGameTickTime = 3.5f; // Tick update de la corruption par défaut (difficulté à 1)    
        public const float WishedPourcentageOfCleanser = 0.035f;
        ...
        public const int MaxNumOfUltraCorruped = 3; // max d'ultra corrupted (rouge) quand la difficulté est à 1
        ...
        public const float DifficultyModifier = 0.3f; //Incrément de la diffulté
        public const float MinStableDifficultyThreshold = 0.35f; // Pourcentage plancher decrease difficulty
        public const float MaxStableDifficultyThreshold = 0.55f; // Pourcentage plancher increase difficulty
        ...
        public const float TargetIntervalBetweenClimaxes =280.0f; // Durée souhaité  entre les climax
        public const float CriticalOnHexRatio = 0.06f; // Taux d'occupation du plancher minimum pour que le réservoir ne se vide pas
        public const float BatteryLevelLostWhenCritical = -0.05f; // Pourcentage du réservoir perdu si necessaire
        ...
        public const int AmountOfSpawnedCleanserOnRecipe = 3;
        public const float AutoUnlockHexAfter = 3f;
