...
{ 
    ...
    {
        public const float DefaultGameTickTime = 1.8f; // Tick update de la corruption par défaut (difficulté à 1)     
        ...
        public const float TargetIntervalBetweenClimaxes =180.0f; // Durée souhaité  entre les climax
